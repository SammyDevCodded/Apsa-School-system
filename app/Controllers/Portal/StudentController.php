...
class StudentController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Fetch specific class name if needed
    ...
    public function profile()
    {
        ...
        $this->view('portal/student/profile', [
            'student' => $student
        ]);
    }
    ...
    public function academics()
    {
        ...
        // Organise results by Exam/Term if possible, or just list them
        // For simplicity, we pass the raw list and let the view handle grouping or simple table
        
        $this->view('portal/student/academics', [
            'results' => $results
        ]);
    }
