<?php $title = 'Academics'; ob_start(); ?>

<div class="max-w-6xl mx-auto">
    <div class="glass-panel p-8 rounded-2xl mb-8">
        <h1 class="text-3xl font-bold text-white mb-2">Academic Performance</h1>
        <p class="text-white/70">View your detailed exam results and continuous assessment scores.</p>
    </div>
