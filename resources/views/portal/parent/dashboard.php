...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="md:col-span-3 glass-panel p-6 rounded-2xl relative overflow-hidden">
        <div class="relative z-10">
            <h1 class="text-3xl font-bold text-white mb-2">My Ward Overview</h1>
            <p class="text-white/80">Viewing academic and financial progress for <strong><?= htmlspecialchars($student['first_name'] . ' ' . $student['last_name']) ?></strong>.</p>
        </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <div class="glass-panel p-6 rounded-xl">
        <h3 class="text-lg font-bold text-white mb-4">School Announcements</h3>
        <ul class="space-y-4">
             ...
             <li class="border-b border-white/10 pb-2">
                <p class="text-white font-medium">PTA Meeting Scheduled</p>
     ...
     <div class="glass-panel p-6 rounded-xl">
        <h3 class="text-lg font-bold text-white mb-4">Ward's Timetable Today</h3>
         <div class="space-y-3">
