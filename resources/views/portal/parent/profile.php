<?php $title = 'Ward Profile'; ob_start(); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="glass-panel p-6 rounded-xl">
            <h3 class="text-xl font-bold text-white mb-6 border-b border-white/10 pb-2">Ward Information</h3>
            <div class="space-y-4">
                <div>
        ...
        <div class="glass-panel p-6 rounded-xl">
            <h3 class="text-xl font-bold text-white mb-6 border-b border-white/10 pb-2">Guardian on Record</h3>
            <div class="space-y-4">
                <div>
                    <span class="block text-xs uppercase tracking-wide text-white/50 mb-1">Name</span>
                ...
                <div class="bg-blue-500/20 p-3 rounded-lg border border-blue-500/30">
                    <p class="text-sm text-blue-200">
                        <span class="font-bold">Note:</span> To update these details, please contact the school administration.
                    </p>
                </div>
            </div>
        </div>
