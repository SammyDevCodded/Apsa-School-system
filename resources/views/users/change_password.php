...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Change Password for <?= htmlspecialchars($user['username']) ?></h1>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6">
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Enter a new password for this user.</p>
            </div>
            <div class="border-t border-gray-200">
                <form action="/users/<?= $user['id'] ?>/change_password" method="POST" class="px-4 py-5 sm:p-6">
